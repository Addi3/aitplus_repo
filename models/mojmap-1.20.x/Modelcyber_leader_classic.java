...
public class Modelcyber_leader_classic<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cyber_leader_classic"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = player.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(32, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(56, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(0, 50)
						.addBox(-3.0F, 1.0F, -4.0F, 6.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(57, 5)
						.addBox(-1.0F, 1.0F, -4.2F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(58, 0)
						.addBox(-3.0F, 8.0F, -4.0F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 12)
						.addBox(-1.5F, 8.0F, -4.2F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 25)
		...
		PartDefinition head = player.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -9.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(33, 0)
						.addBox(-6.0F, -11.0F, 0.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 8)
