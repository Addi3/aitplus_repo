...
public class Modelfly<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Fly = partdefinition.addOrReplaceChild("Fly", CubeListBuilder.create().texOffs(2, 2).addBox(
				-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Wing1 = partdefinition.addOrReplaceChild("Wing1",
				CubeListBuilder.create().texOffs(-3, 0).mirror()
						.addBox(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(1.0F, 22.0F, -0.5F));

		PartDefinition Wing2 = partdefinition.addOrReplaceChild("Wing2", CubeListBuilder.create().texOffs(-3, 0).addBox(
				-2.0F, 0.0F, -1.5F, 2.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 22.0F, -0.5F));
