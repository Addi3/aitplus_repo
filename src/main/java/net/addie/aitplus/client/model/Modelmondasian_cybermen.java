...
public class Modelmondasian_cybermen<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("aitplus", "modelmondasian_cybermen"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = player.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(32, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(0, 50)
						.addBox(-3.0F, 1.0F, -4.0F, 6.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 5).addBox(-1.0F, 1.0F, -4.2F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
						.addBox(-4.0F, 8.0F, -4.0F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 12).addBox(-1.5F, 8.0F, -4.2F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(26, 52)
						.addBox(1.8F, 8.0F, -4.2F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(57, 16).addBox(-3.5F, 8.0F, -4.2F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 25)
		...
		PartDefinition head = player.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 32).addBox(-6.0F, -13.0F, 0.0F, 12.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition headset_r1 = head.addOrReplaceChild("headset_r1", CubeListBuilder.create().texOffs(16, 50).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
