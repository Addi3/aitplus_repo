...
public class Modelold_dalek<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("aitplus", "modelold_dalek"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bulbs = Skirt.addOrReplaceChild("bulbs",
				CubeListBuilder.create().texOffs(0, 63).addBox(-12.0F, -2.0F, 2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-12.0F, -2.0F, 5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-12.0F, -2.0F, 8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-12.0F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-11.9F, -7.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-11.9F, -7.0F, 2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-11.9F, -7.0F, 5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-11.9F, -7.0F, 8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).mirror()
						.addBox(-1.0F, -2.0F, 8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror().addBox(-1.1F, -7.0F, 8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror()
						.addBox(-1.1F, -7.0F, 5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror().addBox(-1.0F, -2.0F, 5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror()
						.addBox(-1.0F, -2.0F, 2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror().addBox(-1.1F, -7.0F, 2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror()
						.addBox(-1.1F, -7.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 63).mirror().addBox(-1.0F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(6.0F, 9.0F, -4.0F));
		PartDefinition cube_r1 = bulbs.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 63).addBox(-0.5F, -1.0F, -5.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, -2.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-0.5F, -1.0F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, 3.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -6.0F, -1.7F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r2 = bulbs.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 63).addBox(-0.5F, -1.0F, -5.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, -2.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-0.5F, -1.0F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, 3.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-0.5F, 4.0F, -5.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, 4.0F, -2.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-0.5F, 4.0F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, 4.0F, 3.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -6.0F, 9.8F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r3 = bulbs.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 63).addBox(-0.5F, -1.0F, -5.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63)
						.addBox(-0.5F, -1.0F, -2.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-0.5F, -1.0F, 3.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(0, 18).addBox(-3.5F, -5.0F, -3.0F, 7.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(55, 0).addBox(-4.5F, -2.0F, -4.0F, 9.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(55, 10)
						.addBox(-4.5F, -4.0F, -4.0F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(55, 10).addBox(-4.5F, -3.0F, -4.0F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)),
